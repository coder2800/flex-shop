function mobile() {
    ...
    document.getElementById('brand-img3').src = './assets/mobile3.jpg'
...
function laptop() {
    ...
    document.querySelector('brand-img1').src = './assets/poco1.jpg'
    document.querySelector('brand-img2').src = './assets/mobile2.jpg'
    document.querySelector('brand-img3').src = './assets/mobile3.jpg'
    document.querySelector('brand-img4').src = './assets/mobile4.jpg'
